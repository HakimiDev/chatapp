<template>
    <li @click="handleClick" class="min-w-full flex flex-row p-2 rounded cursor-pointer transition duration-150 hover:bg-primary-500">
        ...
        <div class="w-full p-2 text-lg max-xs:text-xs flex flex-col flex-1">
            ...
            <div class="w-full ps-2 flex flex-row justify-between items-center overflow-hidden">
                ...
                <div v-if="user.newMessages > 0"
                    ...
                    class="h-7 bg-secondary-100 mt-1 text-black font-semibold rounded-full flex justify-center items-center p-3">
