<template>
    ...
    <header class="w-full fixed top-0 flex items-center z-10">
        <div class="min-w-full bg-primary-100 flex justify-between items-center p-4 rounded-b">
            ...
            <div class="w-fit cursor-pointer transition duration-500 hover:-rotate-180">
                <svg @click="toogleShowSettings" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
